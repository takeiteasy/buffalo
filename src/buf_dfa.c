/*
 * buf_dfa.c -- definitions for buf_dfa.h (subset construction: epsilon-NFA -> DFA over alphabet equivalence classes).
 *
 ...
 * pulls the declarations in with `#include @comptime "buf_dfa.h"` and lists
