/*
 * buf_grammar.c -- definitions for buf_grammar.h (LALR(1) parser table construction over the %grammar section).
 *
 ...
 * pulls the declarations in with `#include @comptime "buf_grammar.h"` and lists
