/*
 * buf_tokcheck.c -- definitions for buf_tokcheck.h (validate a checked-in <name>_tokens.h against a spec's %tokens list).
 *
 ...
 * pulls the declarations in with `#include @comptime "buf_tokcheck.h"` and lists
